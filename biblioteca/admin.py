...
from .models import (Nicho, Livro, Aluno, Professor_Funcionario,
                     StatusEmprestimo, Emprestimo, LivroEmprestimo,
                     ConsultaLivroAdmin, EmprestimoAdmin, ReservaLivro, SugestaoLivro)
from .models import Nicho, Livro, Aluno, Professor_Funcionario, StatusEmprestimo, Emprestimo, LivroEmprestimo, ConsultaLivroAdmin, EmprestimoAdmin, ReservaLivro
