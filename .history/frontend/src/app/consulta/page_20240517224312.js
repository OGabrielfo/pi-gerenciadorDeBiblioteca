    ...
    <div>
      ...
      <div className={styles.container}>
        <div className={styles.title}>
          ...
          <input className={styles.input} type="text" placeholder="Digite o título do livro" value={nome_do_livro} onChange={(e) => setNomeLivro(e.target.value)} />
        </div>
        ...
        <div className={styles.gen}>
          ...
          <input className={styles.input} type="text" placeholder="Digite o gênero do livro" value={tipo} onChange={(e) => setGenero(e.target.value)} />
        </div>
