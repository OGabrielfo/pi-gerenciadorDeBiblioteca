...
const SuggestionForm = () => {
    ...
    <input type="text" name="sala" value={formData.sala} onChange={handleChange} placeholder="Digite sua sala" required />
</div>
<div>
            <div>
                <label>Período: </label>
...
<label>Título do Livro <span style={{color: 'red'}}>*</span></label>
    <input type="text" name="tituloLivro" value={formData.tituloLivro} onChange={handleChange} placeholder="Digite o título do livro" required />
</div>
            <div>
