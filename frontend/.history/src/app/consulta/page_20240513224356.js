...
export default function consulta() {
  ...
  const livros = [
    ...
    {codigo: '2', titulo: 'LIVRO2', autor: 'AUTOR2', genero: 'GENERO2', nicho: 'Nicho10', disponiveis: 1}
    {codigo: '3', titulo: 'LIVRO3', autor: 'AUTOR1', genero: 'GENERO2', nicho: 'Nicho87', disponiveis: 10}
