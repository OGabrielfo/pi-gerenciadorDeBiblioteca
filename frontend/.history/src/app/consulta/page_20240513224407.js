...
export default function consulta() {
  ...
  const livros = [
    { codigo: '1', titulo: 'LIVRO1', autor: 'AUTOR1', genero: 'GENERO1', nicho: '1', disponiveis: 10 },
    {codigo: '2', titulo: 'LIVRO2', autor: 'AUTOR2', genero: 'GENERO2', nicho: '10', disponiveis: 1}
    {codigo: '3', titulo: 'LIVRO3', autor: 'AUTOR1', genero: 'GENERO2', nicho: '87', disponiveis: 10}
